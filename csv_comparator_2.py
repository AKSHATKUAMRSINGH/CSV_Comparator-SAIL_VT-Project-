# Your code as given previously, now with the updated export_to_pdf() method
...
class CSVComparatorApp:
    ...
    def apply_light_mode(self):
        ...
        self.style.configure("TFrame", background="#6034da")
        self.style.configure("TLabel", font=("Segoe UI", 10), background="#f4f4f4")
        self.style.configure("TButton", font=("Segoe UI", 10), padding=6)
        self.style.configure("TNotebook", background="#41c74a")
    ...
    def create_widgets(self):
        ...
        ttk.Label(frm_top, text="Changes CSV:").grid(row=2, column=0, sticky='e', padx=5, pady=5)
        ...
        try:
            ...
            for idx, row_data in enumerate(data):
                if row_data[1] == '' and row_data[0]:
                    table_style.add('LINEABOVE', (0, idx), (-1, idx), 2, colors.black)
